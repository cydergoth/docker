...
RUN apk add --no-cache git openssh-client curl zip unzip ttf-dejavu fontconfig
...
#RUN ls -l /usr/local/bin /bin/bash && chmod +x /bin/bash

#RUN apk add build-base
#USER ${user}
ENTRYPOINT ["/sbin/tini-static", "--", "/usr/local/bin/jenkins.sh"]
#ENTRYPOINT ["/sbin/tini-static", "-vvv", "--", "/bin/bash"]
